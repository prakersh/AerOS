...
const METRICS: PlaceholderMetric[] = [
  {
    ...
    description: "Mean time for vendor quote submissions",
  },
  {
    label: "Extraction Success Rate",
    description: "AI line-item extraction accuracy",
  },
  {
...
export default function BuyerObservability() {
  return (
    <div className="space-y-6 p-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-500">
          AI call telemetry, latency tracking, and cost reporting.
        </p>
      </div>
      ...
      <div className="rounded-xl border border-dashed border-zinc-700 bg-zinc-900/50 p-6 text-center">
        ...
        <p className="mt-1 text-xs text-zinc-600">
          Metrics, traces, and cost breakdowns will appear here once
